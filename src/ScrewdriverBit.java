public class ScrewdriverBit extends Hardware {
    ...
    public ScrewdriverBit(int partID, String displayName, int amountInStock, double unitCost, double diameterMm, ScrewdriverBitType type) {
    ...
    public String getCategoryDetails() {
        return String.format("Category: Screwdriver Bit, PartID: %d, Display Name: %s, Amount Left In Stock: %d, Unit Cost: %f, Diameter (mm): %f, Type: %s,",
