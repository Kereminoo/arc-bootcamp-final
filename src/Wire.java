public class Wire extends Hardware {
    ...
    public Wire(int partID, String displayName, int amountInStock, double unitCost, double gaugeMmSquared,
            double lengthMeters, WireInsulationColor insulationColor) {
    ...
    public String getCategoryDetails() {
        return String.format(
                "Category: Wire, PartID: %d, Display Name: %s, Amount Left In Stock: %d, Unit Cost: %f, Gauge (mm²): %f, Length (m): %f, Insulation Color: %s",
                getPartID(), getDisplayName(), getAmountInStock(), getUnitCost(), gaugeMmSquared, lengthMeters,
                insulationColor);
    }
