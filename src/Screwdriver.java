public class Screwdriver extends Hardware {
    ...
    public Screwdriver(int partID, String displayName, int amountInStock, double unitCost, double diameterMm,
    ...
    public String getCategoryDetails() {
        return String.format(
                "Category: Screwdriver, PartID: %d, Display Name: %s, Amount Left In Stock: %d, Unit Cost: %f, Diameter (mm): %f, Type: %s,",
